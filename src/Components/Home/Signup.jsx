...
const SignUp = ({ handleHidden, handleMethod }) => {
    ...
    const handleSubmit = () => {
        if (userName === null || userEmail === null || userPassword === null) {
            ...
            axios.post("http://localhost:5000/createUser", userDetails).then(function (response) {
                    ...
                    <div className="p-4 flex justify-center">
                        <form className="w-[95%] lg:w-[85%] flex flex-col">
                            ...
                            <div className="md:flex md:items-center mb-3 w-full justify-center">
                                ...
                                <div className="md:w-[80%]">
                                    <input
                                        className="bg-gray-300 rounded-full appearance-none border-2 border-gray-300 w-full py-2 px-4 text-gray-800 leading-tight focus:outline-none  focus:bg-gray-300  "
                                        id="inline-full-name"
                                        type="text"
                                        placeholder="E-mail"
                                        name="email"
                            ...
                            <div className="md:flex md:items-center mb-5 w-full justify-center">
                                {/* <div className="md:w-1/3 flex justify-start">
                                    <label
                                        className="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4"
                            ...
                            <div className="md:flex md:items-center w-full">
                                ...
                                <div className="w-full flex flex-col justify-center items-center">
                                    ...
                                    {
                                        error && <span className='text-red'>Please fill all the details!!!</span>
                                    }
