...
const Navbar_Software = () => {
  ...
  return (
    <>
      ...
      <nav className=" max-w-screen-2xl w-full">
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black">
            <div className="" id="mobile-menu">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <button
                  onClick={() => navigate("/contact")}
                  className="text-gray-300 tracking-[1px] hover:bg-gray-700 hover:text-white block px-3 py-3 rounded-md text-base font-medium"
                >
                  Contact Us
                </button>
                <button
                ...
                <button
                  ...
                  // onClick={() => { handleSignup() }}
                  className="text-secondary bg-primary hover:bg-gray-700 hover:text-white block px-3 py-3 rounded-md text-base font-medium"
                >
                  Create Free Account
                </button>
              </div>
            ...
            <button
              onClick={toggleNavbar}
              className="absolute top-0 right-0 m-4 p-2 text-gray-400 hover:text-white"
...
export default Navbar_Software;
